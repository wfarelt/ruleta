...
from .views import execute_draw, roulette_view, draw_history, reset_draw, save_rotation_angle, restore_temporarily_removed
...
urlpatterns = [
    ...
    path('restore-temporary/<int:pasanaku_id>/', restore_temporarily_removed, name='restore_temporarily_removed'),
